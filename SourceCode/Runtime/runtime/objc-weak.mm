 ...
 */
// WGRuntime: dealloc 对象销毁时，销毁对象的弱引用，并将弱引用的指针置为nil
//MARK: ⚠️dealloc销毁对象第7⃣️步
void 
weak_clear_no_lock(weak_table_t *weak_table, id referent_id) 
{
    ...
    //遍历存放弱引用的数组，若若引用的地址指向该对象，则将该弱引用置为nil
